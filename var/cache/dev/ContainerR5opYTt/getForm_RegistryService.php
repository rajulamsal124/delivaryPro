...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\AbstractRegistrationFormType' => ['privates', 'App\\Form\\AbstractRegistrationFormType', 'getAbstractRegistrationFormTypeService', true],
            'App\\Form\\CategoryFormType' => ['privates', 'App\\Form\\CategoryFormType', 'getCategoryFormTypeService', true],
            'App\\Form\\CustomerFormType' => ['privates', 'App\\Form\\CustomerFormType', 'getCustomerFormTypeService', true],
            'App\\Form\\CustomerRegistrationFormType' => ['privates', 'App\\Form\\CustomerRegistrationFormType', 'getCustomerRegistrationFormTypeService', true],
            'App\\Form\\EmployeeFormType' => ['privates', 'App\\Form\\EmployeeFormType', 'getEmployeeFormTypeService', true],
            'App\\Form\\EmployeeRegistrationFormType' => ['privates', 'App\\Form\\EmployeeRegistrationFormType', 'getEmployeeRegistrationFormTypeService', true],
            'App\\Form\\OrderDetailsFormType' => ['privates', 'App\\Form\\OrderDetailsFormType', 'getOrderDetailsFormTypeService', true],
            ...
            'App\\Form\\AbstractRegistrationFormType' => '?',
            'App\\Form\\CategoryFormType' => '?',
            'App\\Form\\CustomerFormType' => '?',
            'App\\Form\\CustomerRegistrationFormType' => '?',
            'App\\Form\\EmployeeFormType' => '?',
            'App\\Form\\EmployeeRegistrationFormType' => '?',
            'App\\Form\\OrderDetailsFormType' => '?',
